...
import {
  ...
  actualizarDetalle_CompraPatch,
} from "../Controller/Detalles_compras.controller.js";
...
router.delete(
  "/eliminardetalle_compra/:id_detalle_compra",
  eliminarDetallecompra
);

//ruta para actualizarvel detalle_compra
router.patch(
  "/actualizarDetalle_CompraPatch/:id_detalle_compra",
  actualizarDetalle_CompraPatch
);
